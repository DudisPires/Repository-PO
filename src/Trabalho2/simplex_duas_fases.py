...
class TwoPhaseSimplex:
    ...
    def resolver(self, verbose=True): 
        ...
        # Instancia o solver para a Fase 1
        ...
        # Resolve a Fase 1
        solver_f1.resolver(verbose=verbose)

        # Checa o resultado da Fase 1
        ...
        if abs(valor_otimo_w) > 1e-9:
            ...
            return 'inviavel', None, None # Retorno estruturado
        ...
        # Preparação da Fase 2 (código existente, sem alterações)
        # ... (todo o bloco de código para preparar a tabela da fase 2) ...
        # ... (vou omitir por brevidade, mas ele continua o mesmo) ...
        ...
        # Instancia o solver para a Fase 2
        ...
        solver_f2.variaveis_base = np.array(list(base_f2))
        
        # Resolve a Fase 2
        solver_f2.resolver(verbose=verbose)

        # RETORNA A SOLUÇÃO ESTRUTURADA
        return solver_f2.get_solucao()